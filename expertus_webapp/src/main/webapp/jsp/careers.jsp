...
<head>
	...
	<body>
		...
		<div>
			<form:form id="CareersForm" modelAttribute="job" action="/careers/{refjob}/" method="get">
				<table>
		        	<tr>
		        		<td>Username :</td>
		        		<td>${username}</td>
        		...
        		<div>
             		<form:button align="center" id="/careers/{refjob}/" name="/careers/{refjob}/">Apply for this job</form:button>
				</div>
			</form:form>
		</div>
		<div>
